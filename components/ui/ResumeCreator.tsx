        ...
        <div className="max-w-5xl mx-auto py-12 px-4">
            ...
            <div className="mb-10">
                ...
                <p className="text-muted-foreground text-lg">
                    Use a template or paste your own job description to generate a tailored resume.
                </p>
            </div>
                    ...
                    <div className="space-y-3">
                        ...
                        >
                            ...
                            <div className="flex items-center justify-center gap-3 text-muted-foreground">
                                ...
                                <span className="text-sm">Add extra attachments (PDF, DOCX, TXT)</span>
                            </div>
                        </div>
                                ...
                                >
                                    {attachments.map((file, index) => (
                                        ...
                                        >
                                            ...
                                            <button onClick={() => removeAttachment(index)} className="hover:text-foreground">
                                                <X className="w-3 h-3" />
                                            </button>
                                        </motion.div>
                                    ))}
